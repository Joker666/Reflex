...
- Automatic browser discovery does not imply automatic profile discovery. Chromium profile targets remain an optional manual refinement because profile storage is browser-specific and may expose private local metadata.
